...
덕어올 수 있다. 사용시 context root를 제외한 /로 시작하는 절대경로를
입력해야 한다.
--%>
...
<%--
선언부에서 JSP의 내장객체를 사용할 때는 해당 내장객체의 클래스타입으로
사용해야 한다. application객체는 ServletContext타입을
가지고있다.
 --%>
