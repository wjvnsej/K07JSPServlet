...
<%-- 
	선언부(Declaration) : 스크립트렛이나 표현식에서 사용 할
		메소드를 선언 할 때 사용된다. 함수는 주로 중복해서 사용하는
		경우가 많으므로 src(자바영역)dmf aksgdl tkdydgksek.
--%>
<%!
...
<body>
	...
	<%-- 
	스크립트렛(Scriptlet) : 주로 JSP코드를 작성하고 실핼할 때 사용하는
	...
	<%-- 
	표현식(Expression) : 변수를 웹 브라우저 상에 출력할 때 사용한다.
		JS의 document.write()와 동일한 역할을 한다. 표현식 사용 시
		주의할 점은 문장 끝에 ;(세미콜론)을 생략해야 하는 것이다.
